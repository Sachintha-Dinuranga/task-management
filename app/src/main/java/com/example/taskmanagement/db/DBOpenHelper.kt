...
import com.example.taskmanagement.utils.COLUMN_NAME_DESCRIPTION
import com.example.taskmanagement.utils.COLUMN_NAME_TITLE
import com.example.taskmanagement.utils.TABLE_NAME
...
class DBOpenHelper(context: Context) : SQLiteOpenHelper(
    ...
    fun readNotes(): MutableList<TaskModel> {
